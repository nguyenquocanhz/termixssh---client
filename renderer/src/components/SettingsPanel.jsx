      ...
      <div className="max-w-[600px]">
        ...
        <div className="mb-8">
          ...
          <div className="bg-[#111827] border border-[#1e2d3d] rounded-xl p-5 text-xs text-slate-500">
            ...
            <div className="mb-4 text-slate-600">© 2026 — Built with ❤️</div>
            
            <div className="border-t border-[#1e2d3d] pt-4 mt-2">
              <div className="text-slate-400 font-medium mb-1.5">Về VtechZones</div>
              <div className="leading-relaxed mb-2">
                VtechZones là cộng đồng chia sẻ kiến thức công nghệ, lập trình và quản trị hệ thống. Termix được phát triển nhằm mang lại một công cụ tối ưu, nhẹ và mạnh mẽ cho các DevOps và System Admin trong cộng đồng.
              </div>
              <a href="https://vtechzones.com" target="_blank" rel="noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors font-medium">
                Truy cập VtechZones ➔
              </a>
            </div>
          </div>
